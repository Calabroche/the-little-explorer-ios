    ...
    var body: some View {
        ...
        .task(id: environment.session.token) {
            ...
            if token != nil {
                ...
                // Push notifications are OFF for now — they need a paid Apple
                // Developer account (APNs key + Push capability). The code is
                // kept dormant; re-add aps-environment + this call to enable.
